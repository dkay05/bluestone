              ...
              <tr>
                ...
                {['STD', 'ECN', 'PRO'].map((col) => (
                  <td key={col} className="px-6 py-6 text-center">
                    <button className="px-8 py-2.5 rounded-full border-2 border-red-500 text-red-400 hover:bg-red-500 hover:text-white font-semibold transition-all duration-300">
                      Register
                    </button>
                  </td>
                ))}
